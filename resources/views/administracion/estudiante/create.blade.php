...
@section('content')
<div class="container">
    <x-misc-title title="Crear Estudiante" back="{{ route('menu.administracion') }}" />
            ...
            <form action="#" method="post" id="form">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="email" autofocus required value="{{old('email')}}" name="email" class="form-control @if($errors->has('email')) is-invalid @endif" placeholder="Email" autofocus>
                    </div>
                    <div class="col-12 col-md-6">
